...
//     difficulty: 'EASY',
//     hint: '',
//     topic: null, // will store a topic object
//     options: [''], // start with one empty option
//     correctOptions: [], // stores option texts that are correct
//   });
...
//   // Handler for input changes for simple text fields.
...
//   // Handler for changing options (each option has its own input).
...
//   // Toggle the correct option checkbox.
//   // We store the option text that is marked correct.
...
//   // Handle change on the topic dropdown.
...
//   // Submit handler for the new question.
//   const handleSubmit = (e) => {
//     e.preventDefault();
//     // Optionally, include the createdBy username from localStorage if needed.
//     const payload = {
//       ...questionData,
//       // You can also send additional fields here if required.
//     };
    
//     axios.post('http://localhost:8080/questions/create-question', payload)
//       .then(response => {
...
//         {/* Options with Checkboxes for Correct Answers */}
//         <div>
...
//     correctOptions: [],// Stores option texts that are marked as correct
//   });
...
//   // Toggle correct option checkbox.
//   const handleCheckboxChange = (option) => {
//     let updatedCorrectOptions = questionData.correctOptions ? [...questionData.correctOptions] : [];
//     if (updatedCorrectOptions.includes(option)) {
//       updatedCorrectOptions = updatedCorrectOptions.filter(opt => opt !== option);
...
//     // Build the payload as per your endpoint.
//     const payload = {
